...
![](assets/agent-eval/01-model-evaluation-evolution.jpg)
...
![](assets/agent-eval/02-agent-execution-chain.jpg)
...
![](assets/agent-eval/03-business-metric-bridge.jpg)

这两类指标不能直接映射，中间必须有一层面向任务系统的桥梁指标。我们提供一种分层思路如下：

![](assets/agent-eval/04-evaluation-layering.jpg)
...
![](assets/agent-eval/05-objective-subjective-evaluation.jpg)
...
![](assets/agent-eval/06-human-machine-alignment.jpg)
...
![](assets/agent-eval/07-rubric-example.jpg)
...
![](assets/agent-eval/08-domain-expert-knowledge.jpg)
...
![](assets/agent-eval/09-long-short-agent.jpg)
...
![](assets/agent-eval/10-short-agent-evaluation.jpg)

在过去1年的发展中图灵形成了成熟的解决方案，包括人工评测、机器评测，部分案例如下：

![](assets/agent-eval/11-short-agent-cases.jpg)
...
![](assets/agent-eval/12-long-agent-evaluation.jpg)
...
![](assets/agent-eval/13-skill-user-profile.jpg)
...
![](assets/agent-eval/14-skill-lifecycle.jpg)

综上，Skill评测的痛点总体可以拆解成三个方面：

![](assets/agent-eval/15-skill-evaluation-pain-points.jpg)
...
![](assets/agent-eval/16-task-evaluation-model.jpg)
...
![](assets/agent-eval/17-long-short-agent-difference.jpg)
...
![](assets/agent-eval/18-agent-evaluation-landscape.jpg)

2026年2月，龙虾在全球爆火时候，社区涌现出面向龙虾评测的开源软件：

![](assets/agent-eval/19-open-source-evaluation-tools.jpg)

图片链接可访问原文。

**阅读原文**：https://mp.weixin.qq.com/s/gZKWRqznB8sNBFf69fBIvw

关注「美团技术团队」微信公众号（meituantech）或访问：https://tech.meituan.com/，阅读更多技术干货！

![](assets/agent-eval/20-article-cover.jpg)

本文系美团技术团队出品，著作权归属美团。欢迎出于分享和交流等非商业目的转载或使用本文内容，敬请注明“内容转载自美团技术团队”。本文未经许可，不得进行商业性转载或者使用。任何商用行为，请发送邮件至 tech@meituan.com 申请授权。

## 原文与说明

- [知乎原文](https://zhuanlan.zhihu.com/p/2068995699606295771)
- 本文用于学习和知识整理，原文著作权归原作者及相关权利人所有。
